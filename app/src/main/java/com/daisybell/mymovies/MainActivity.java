...
import com.daisybell.mymovies.utils.JSONUtils;
import com.daisybell.mymovies.utils.NetworkUtils;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBarLoader = findViewById(R.id.progressBarLoading);
    ...
    private void setMethodOfSort(boolean isTopRated) {
        if (isTopRated) {
            ...
            textViewPopularity.setTextColor(getResources().getColor(R.color.write_color));
            methodOfSort = NetworkUtils.TOP_RATED;
        } else {
            textViewTopRated.setTextColor(getResources().getColor(R.color.write_color));
